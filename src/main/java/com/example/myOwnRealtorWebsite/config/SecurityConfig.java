...
public class SecurityConfig {
    ...
    public InMemoryUserDetailsManager inMemoryUserDetailsService() {
        UserDetails admin = User.builder()
                ...
                .password(passwordEncoder().encode("Lionking@123"))
                .roles("ADMIN")
                .build();
...
//        return (UserDetails) userRep.findByEmail(email)
...
//        provider.setUserDetailsService(userDetailsService);  // wires loadUserByUsername
//        provider.setPasswordEncoder(passwordEncoder);
//        return provider;
//    }
